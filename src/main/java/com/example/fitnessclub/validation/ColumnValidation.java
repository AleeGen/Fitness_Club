...
public final class ColumnValidation {
    ...
    public static final String REGEX_NAME = "^\\p{L}{2,}$";
    public static final String REGEX_LASTNAME = "^\\p{L}{2,}$";
    ...
    public static final String REGEX_CORPORATE = "(true)|(false)$"; //Pattern.CASE_INSENSITIVE вставить как второй параметр в pattern для ignore case
    public static final String REGEX_VISIT_PERIOD_MONTHS = "^\\d*$";
