        ...
        <div class="form-row">
            ...
            <form action="${pageContext.request.contextPath}/controller" method="post"
                ...
                <div>
                    ...
                    <input type="radio" name="sex" value="male" <c:if test="${sex.equals('male')}"> checked</c:if>>
                    <label style="margin-top: 4%"><fmt:message key="field.user.sex.male"/></label>
                    <input type="radio" name="sex" value="female" <c:if test="${sex.equals('female')}"> checked</c:if>>
                    <label style="margin-top: 4%"><fmt:message key="field.user.sex.female"/></label>
                </div>
                <div>
