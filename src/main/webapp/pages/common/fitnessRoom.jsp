...
<head>
    ...
    <title><fmt:message key="fitness_room"/></title>
        ...
        <article id="post-1" class="post">
            <div class="slideshow-container">
                <div class="mySlides fade">
                    <img src="pictures/detail/fitness_club_1.jpg" style="width:100%">
                </div>
                <div class="mySlides fade">
                    <img src="pictures/detail/fitness_club_2.jpg" style="width:100%">
                </div>
                <div class="mySlides fade">
                    <img src="pictures/detail/fitness_club_3.jpeg" style="width:100%">
                </div>
                <div class="mySlides fade">
                    <img src="pictures/detail/fitness_club_4.jpg" style="width:100%">
                </div>
            ...
            <div class="post-content">
                <h2 class="post-title"><fmt:message key="fitness_room"/></h2>
                <hr>
                <p>
                    <jsp:include page="/text/fitnessClub.htm"/>
                </p>
