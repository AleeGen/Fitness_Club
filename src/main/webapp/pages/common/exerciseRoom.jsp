...
<head>
    ...
    <title><fmt:message key="exercise_room"/></title>
        ...
        <article id="post-1" class="post">
            <div class="slideshow-container">
                <div class="mySlides fade">
                    <img src="pictures/detail/exercise_room_1.jpeg" style="width:100%">
                </div>
                <div class="mySlides fade">
                    <img src="pictures/detail/exercise_room_2.jpg" style="width:100%">
                </div>
                <div class="mySlides fade">
                    <img src="pictures/detail/exercise_room_3.jpg" style="width:100%">
                </div>
                <div class="mySlides fade">
                    <img src="pictures/detail/exercise_room_4.jpg" style="width:100%">
                </div>
            ...
            <div class="post-content">
                <h2 class="post-title"><fmt:message key="exercise_room"/></h2>
                <hr>
                <p>
                    <jsp:include page="/text/exerciseRoom.htm"/>
                </p>
