...
<head>
    ...
    <title><fmt:message key="swimming"/></title>
        ...
        <article id="post-1" class="post">
            <div class="slideshow-container">
                <div class="mySlides fade">
                    <img src="pictures/detail/swimming_1.jpg" style="width:100%">
                </div>
                <div class="mySlides fade">
                    <img src="pictures/detail/swimming_2.jpg" style="width:100%">
                </div>
                <div class="mySlides fade">
                    <img src="pictures/detail/swimming_3.jpg" style="width:100%">
                </div>
                <div class="mySlides fade">
                    <img src="pictures/detail/swimming_4.jpg" style="width:100%">
                </div>
            ...
            <div class="post-content">
                <h2 class="post-title"><fmt:message key="swimming"/></h2>
                <hr>
                <p>
                    <jsp:include page="/text/swimming.htm"/>
                </p>
