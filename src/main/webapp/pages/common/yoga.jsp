...
<head>
    ...
    <title><fmt:message key="yoga"/></title>
        ...
        <article id="post-1" class="post">
            <div class="slideshow-container">
                <div class="mySlides fade">
                    <img src="pictures/detail/yoga_1.jpg" style="width:100%">
                </div>
                <div class="mySlides fade">
                    <img src="pictures/detail/yoga_2.jpg" style="width:100%">
                </div>
                <div class="mySlides fade">
                    <img src="pictures/detail/yoga_3.jpg" style="width:100%">
                </div>
                <div class="mySlides fade">
                    <img src="pictures/detail/yoga_4.jpg" style="width:100%">
                </div>
            ...
            <div class="post-content">
                <h2 class="post-title"><fmt:message key="yoga"/></h2>
                <hr>
                <p>
                    <jsp:include page="/text/yoga.htm"/>
                </p>
